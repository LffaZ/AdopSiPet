<x-petcontributor-layout>
    ...
    <div class="w-3/4 bg-gray-200 rounded-full dark:bg-gray-700">
            <div class="bg-[#FF862F] text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" style="width: 100%"></div>
        </div>
        <div class="flex flex-col w-full mt-1 justify-center items-center">
            <form id="form-pet-health" method="POST" action="/petcontributor/pethealths/{{ $pet }}/store" class="w-1/2 py-3 px-6 bg-white rounded-lg flex flex-col justify-center gap-2">
                @csrf
                <div class="mb-3">
            ...
            <div class="w-full flex gap-3 justify-center">
                <a href="/petcontributor/petdetails/{{ $petdetail->kd }}/edit" class="text-white w-1/6 bg-blue-400 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kembali</a>
