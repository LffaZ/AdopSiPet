        ...
        <div class="max-w-7xl mx-auto w-2/3 sm:px-6 lg:px-8">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="h-auto w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <caption class="p-5 pb-2 mb-2 text-3xl font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                        Daftar Hewan
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                ...
                                <a href="{{ route('petcontributor.pets.export') }}">
                    ...
                    <tbody>
                        @foreach($pets as $pet)
                            <tr x-data="{ url: '/petcontributor/pets/{{ $pet->kd }}' }" x-on:click="window.location.href = url" class="bg-white border-b text-base dark:bg-gray-800 dark:border-gray-700 hover:cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-600">
