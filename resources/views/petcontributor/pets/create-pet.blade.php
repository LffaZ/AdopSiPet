<x-petcontributor-layout>
    <div class="flex flex-col px-5 justify-center items-center h-screen">
        <div class="w-3/4 bg-gray-200 rounded-full dark:bg-gray-700">
            <div class="bg-[#FF862F] text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" style="width: 33%"></div>
        </div>
        <div class="flex flex-row-reverse w-full mt-5 ">
            <form method="POST" enctype="multipart/form-data" action="{{ route('petcontributor.pets.store') }}" class="p-5 w-full flex flex-row-reverse justify-between">
                @csrf
                    ...
                    <div class="mb-5 flex flex-col">
                        ...
                        <div class="flex mt-1 gap-3">
                            <div class="flex items-center">
                                <input type="radio" name="stts_kepemilikan" value="liar" class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Liar</label>
                            </div>
                            <div class="flex items-center">
                                <input type="radio" name="stts_kepemilikan" value="pribadi" class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
