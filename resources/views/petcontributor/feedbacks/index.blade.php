...
<div class="flex items-center py-7">
        <div class="max-w-7xl mx-auto w-3/4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                ...
                                <a href=" {{ route('admin.dashboard') }}">
                                    <button type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-1 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                        Ekspor
                                    </button>
                                </a>
                            </div>
